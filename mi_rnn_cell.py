...
class BasicLSTMCell(rnn_cell.RNNCell):
  ...
  def __call__(self, inputs, state, scope=None):
    ...
    with vs.variable_scope(scope or type(self).__name__):  # "BasicLSTMCell"
      ...
      concat = mi_linear(inputs, h, 4 * self._num_units, True)
...
class DropoutWrapper(rnn_cell.RNNCell):
...
def mi_linear(arg1, arg2, output_size, global_bias_start=0.0, scope=None):
    ...
    # print("arg1", arg1.get_shape())
    # print("arg2", arg2.get_shape())
    # print("output_size", output_size)
    a1_shape = arg1.get_shape().as_list()[1]
    a2_shape = arg2.get_shape().as_list()[1]
    # total_arg_size = a1_shape + a2_shape
    ...
    with vs.variable_scope(scope or "MILinear"):
        ...
        # matrix_u = vs.get_variable("Matrix", [output_size, a2_shape])
        # biases = vs.get_variable("Biases", [1, output_size],
        ...
        # print("arg1mul shape", arg1mul.get_shape())
        # res.get_shape() == (?, output_size)
        # alpha size = output_size
        res = alpha * arg1mul * arg2mul + (arg1mul * bias1) + (arg2mul * bias2)
        # res = alpha * arg1mul * arg2mul + (arg1mul * biases) + (arg2mul * biases)
